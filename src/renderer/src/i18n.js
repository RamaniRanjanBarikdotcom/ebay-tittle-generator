export const translations = {
  en: {
    ...
    settings: {
      ...
      ameiseRunLatest: 'Run Ameise (latest CSV)',
      ameiseRunPick: 'Pick CSV & run',
      ameiseRunSuccess: 'Ameise import completed',
      ameiseRunFailed: 'Ameise import failed',
      ameiseLocalOnly: 'Saved locally only. Configure App DB to sync online.',
      ameiseRunning: 'Ameise is running...',
      ameiseCancel: 'Stop Ameise',
      ameiseCancelSuccess: 'Ameise stopped',
      ameiseCancelFailed: 'Failed to stop Ameise',
      ameiseLogTime: 'Time',
  ...
  de: {
    ...
    import: {
      ...
      empty: 'Noch keine Daten importiert. Importieren Sie eine Datei für die Vorschau.'
    },
    generate: {
    ...
    settings: {
      ...
      ameiseRunLatest: 'Ameise starten (letzte CSV)',
      ameiseRunPick: 'CSV wählen & starten',
      ameiseRunSuccess: 'Ameise-Import abgeschlossen',
      ameiseRunFailed: 'Ameise-Import fehlgeschlagen',
      ameiseLocalOnly: 'Nur lokal gespeichert. App-DB konfigurieren, um online zu speichern.',
      ameiseRunning: 'Ameise läuft...',
      ameiseCancel: 'Ameise stoppen',
      ameiseCancelSuccess: 'Ameise gestoppt',
      ameiseCancelFailed: 'Ameise konnte nicht gestoppt werden',
      ameiseLogTime: 'Zeit',
      ameiseLogStatus: 'Status',
      ameiseLogFile: 'Datei',
